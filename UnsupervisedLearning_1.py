# -*- coding: utf-8 -*-
"""
Created on Sat May 15 20:01:39 2021
...
points_all = pd.read_csv('Dados/Grains/seeds.csv', sep=',')
# Create arrays for the features and the response variable
y = points_all['f8'].values
X = points_all.drop('f8', axis=1).values

# Create train and test sets
points, new_points, y_train, y_test =  train_test_split(X,y,test_size=0.4, random_state=42)
